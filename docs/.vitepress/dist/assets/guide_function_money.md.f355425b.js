...
function A(a) {
  ...
  return e == '' ? (e += s[0] + l + B) : y || (e += B), e;
}
const P = d({
    __name: 'amountSeparator',
    setup(a) {
      return (s, n) => (i(), r('div', null, c(p(S)(123456789)), 1));
    },
  }),
  ...
  I = d({
    __name: 'centsToYuan',
    setup(a) {
      return (s, n) => (i(), r('div', null, c(p(U)(1234567)), 1));
    },
  }),
  w = Object.freeze(Object.defineProperty({ __proto__: null, default: I }, Symbol.toStringTag, { value: 'Module' })),
  V = d({
    __name: 'formatDecimal',
    setup(a) {
      return (s, n) => (i(), r('div', null, c(p(x)(12345.6789, 2)), 1));
    },
  }),
  O = Object.freeze(Object.defineProperty({ __proto__: null, default: V }, Symbol.toStringTag, { value: 'Module' })),
  Y = d({
    ...
    setup(a) {
      return (s, n) => (
        ...
        r(
          ...
          null,
          [
            t('div', null, c(p(A)(1234567891231234e-4)), 1),
            t('div', null, c(p(A)(1234567891234e-4)), 1),
            t('div', null, c(p(A)(12345.67)), 1),
            t('div', null, c(p(A)(0)), 1),
          ],
          64,
        )
      );
  ...
  R = Object.freeze(Object.defineProperty({ __proto__: null, default: Y }, Symbol.toStringTag, { value: 'Module' })),
  M = d({
    __name: 'yuanToCents',
    setup(a) {
      return (s, n) => (i(), r('div', null, c(p(j)(12345.67)), 1));
    },
  }),
  ...
  z = t(
    'h1',
    { id: 'money', tabindex: '-1' },
    [f('money '), t('a', { class: 'header-anchor', href: '#money', 'aria-hidden': 'true' }, '#')],
    -1,
  ),
  q = t('p', null, '金额转换工具', -1),
  L = t(
    ...
    [f('amountSeparator '), t('a', { class: 'header-anchor', href: '#amountseparator', 'aria-hidden': 'true' }, '#')],
    -1,
  ),
  ...
  e2 = Object.assign(n2, {
    setup(a) {
      const s = Object.assign({
          ...
          '../../example/money/centsToYuan.vue': w,
          '../../example/money/formatDecimal.vue': O,
          '../../example/money/toChineseUpper.vue': R,
