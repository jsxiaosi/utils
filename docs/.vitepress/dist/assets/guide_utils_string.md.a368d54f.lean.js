...
function y(a, n) {
  switch (n) {
    case 'lowerCamelCase':
      return a.replace(/[-_]+(\w)/g, (s, t) => t.toUpperCase());
    case 'upperCamelCase':
      return a.replace(/[-_]+(\w)/g, (s, t) => t.toUpperCase()).replace(/^(\w)/, (s, t) => t.toUpperCase());
    case 'upperCase':
      return a.toUpperCase();
    case 'kebabCase':
      return a.replace(/([a-z0-9]|(?=[A-Z]))([A-Z])/g, '$1-$2').toLowerCase();
    default:
      return a;
  }
}
const h = g({
        ...
        return (
          ...
          k('div', null, [
            ...
            p(
              ...
              { default: o(() => [e(r(s.value ? D(m)(n.value) : n.value), 1)]), _: 1 },
            ),
          ])
        );
      };
  ...
  f = Object.freeze(Object.defineProperty({ __proto__: null, default: h }, Symbol.toStringTag, { value: 'Module' })),
  B = g({
    __name: 'transformString',
    setup(a) {
      const n = E('my-transform-string'),
        s = E(!1),
        t = () => {
          s.value = !s.value;
        };
        ...
        return (
          ...
          k('div', null, [
            ...
            p(
              u,
              { style: { 'margin-left': '12px' }, type: 'danger' },
              { default: o(() => [e(r(s.value ? D(y)(n.value, 'upperCamelCase') : n.value), 1)]), _: 1 },
            ),
          ])
        );
      };
  ...
  v = l(
    ...
    [e('string '), l('a', { class: 'header-anchor', href: '#string', 'aria-label': 'Permalink to "string"' }, '​')],
    -1,
  ),
  T = l(
    'h2',
    ...
    [
      e('stringTrim '),
      l('a', { class: 'header-anchor', href: '#stringtrim', 'aria-label': 'Permalink to "stringTrim"' }, '​'),
    ],
    -1,
  ),
  b = l('p', null, 'string/stringTrim', -1),
  x = A(
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#82AAFF;">transformString</span><span style="color:#A6ACCD;">(</span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">my-transform-string</span><span style="color:#89DDFF;">&#39;</span><span style="color:#89DDFF;">,</span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">upperCamelCase</span><span style="color:#89DDFF;">&#39;</span><span style="color:#A6ACCD;">)</span><span style="color:#89DDFF;">;</span><span style="color:#A6ACCD;"> </span><span style="color:#676E95;font-style:italic;">// &#39;MyTransformString&#39;</span></span></code></pre></div></details><p>参数：</p><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>str</td><td>需要转换的字符串</td><td>string</td><td></td></tr><tr><td>type</td><td>转换类型</td><td>StringTransformType</td><td></td></tr></tbody></table><p>StringTransformType：</p><table><thead><tr><th>参数</th><th>说明</th></tr></thead><tbody><tr><td>lowerCamelCase</td><td>小驼峰(第一个单词首字母小写，其他单词首字母大写)转换，并去掉<code>-</code></td></tr><tr><td>upperCamelCase</td><td>大驼峰(全部单词首字母大写)转换，并去掉<code>-</code></td></tr><tr><td>upperCase</td><td>全部转换为大写，保留<code>-</code></td></tr><tr><td>kebabCase</td><td>大写转小写，带<code>-</code></td></tr></tbody></table><p>返回类型：<code>string</code></p><h2 id="removestring" tabindex="-1">removeString <a class="header-anchor" href="#removestring" aria-label="Permalink to &quot;removeString&quot;">​</a></h2><details class="details custom-block"><summary>示例代码</summary><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;font-style:italic;">import</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span><span style="color:#F07178;"> </span><span style="color:#A6ACCD;">removeString</span><span style="color:#F07178;"> </span><span style="color:#89DDFF;">}</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;font-style:italic;">from</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">@jsxiaosi/utils</span><span style="color:#89DDFF;">&#39;</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#82AAFF;">removeString</span><span style="color:#A6ACCD;">(</span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">my-transform-string</span><span style="color:#89DDFF;">&#39;</span><span style="color:#89DDFF;">,</span><span style="color:#A6ACCD;"> [</span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">-</span><span style="color:#89DDFF;">&#39;</span><span style="color:#89DDFF;">,</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">string</span><span style="color:#89DDFF;">&#39;</span><span style="color:#A6ACCD;">])</span><span style="color:#89DDFF;">;</span><span style="color:#A6ACCD;"> </span><span style="color:#676E95;font-style:italic;">// &#39;mytransform&#39;</span></span></code></pre></div></details><p>参数：</p><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>str</td><td>需要删除的字符串</td><td>string</td><td></td></tr><tr><td>substrings</td><td>需要删除的内容</td><td>string[]</td><td></td></tr></tbody></table><p>返回类型：<code>string</code></p>`,
    11,
  ),
  O = JSON.parse(
    '{"title":"string","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"guide/utils/string.md","filePath":"guide/utils/string.md","lastUpdated":1689344950000}',
  ),
  j = { name: 'guide/utils/string.md' },
  P = Object.assign(j, {
    setup(a) {
      const n = Object.assign({
          '../../example/string/stringTrim.vue': f,
