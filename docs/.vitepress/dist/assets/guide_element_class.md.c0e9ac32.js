...
const h = k(g, [['__scopeId', 'data-v-6626a87f']]),
        ...
        return (
          ...
          i(p, null, {
            default: e(() => [
              ...
              c(
                l,
                { onClick: t[0] || (t[0] = () => C(_)(s.value, 'demo')) },
                { default: e(() => [d('删除class')]), _: 1 },
              ),
            ]),
            _: 1,
          })
...
<span class="line"></span></code></pre></div></details><p>参数:</p><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>ele</td><td>Element</td><td>T extends HTMLElement</td><td></td></tr><tr><td>cls</td><td>class类名</td><td>string</td><td></td></tr></tbody></table>`,
  ...
  j = { name: 'guide/element/class.md' },
  V = Object.assign(j, {
    setup(a) {
      const s = Object.assign({ '../../example/class/addClass.vue': f, '../../example/class/removeClass.vue': b }),
        n = '../../example/class/*.vue';
      return (t, l) => {
        const p = o('Demo');
        return (
