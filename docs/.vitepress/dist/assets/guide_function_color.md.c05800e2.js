  ...
  if (p === 0) E = F = b = e;
    ...
    const i = (v, j, d) => (
        ...
        d < 0.16666666666666666
          ...
          ? v + (j - v) * (0.6666666666666666 - d) * 6
          : v
      ),
      m = e < 0.5 ? e * (1 + p) : e + p - e * p,
      k = 2 * e - m;
...
function M(a, s, n) {
  ...
  return G({ r: p[0], g: p[1], b: p[2] });
}
function S(a, s) {
  if (!a) return [];
  const n = s === 'dark' ? '#141414' : '#ffffff',
    C = [];
  for (let t = 1; t <= 9; t++) C.push(M(a, n, t * 0.1));
  return C;
}
const O = '#409eff',
  X = h({
                  ...
                  { align: 'middle' },
                  {
                    default: c(() => [
                      ...
                      B(
                        ...
                        P(
                          s.value,
                          (e) => (r(), B('div', { key: e, class: 'demo', style: u({ backgroundColor: e }) }, null, 4)),
                        ),
                        128,
                      )),
                    ]),
...
const J = _(X, [['__scopeId', 'data-v-e067a921']]),
          ...
          B(
            ...
            [
              D(
                ...
                {
                  default: c(() => [
                    l('div', { class: 'demo', style: u({ backgroundColor: s.value }) }, null, 4),
                    D(
                      p,
                      {
                        onClick:
                          t[0] ||
                          (t[0] = () => {
                            s.value = s.value === A ? o(M)(s.value, '#141414', 0.5) : A;
                          }),
                      },
                      { default: c(() => [T(y(s.value === A ? '加深' : '还原'), 1)]), _: 1 },
                    ),
                  ]),
                  _: 1,
                },
              ...
              D(
                ...
                {
                  default: c(() => [
                    l('div', { class: 'demo', style: u({ backgroundColor: n.value }) }, null, 4),
                    D(
                      p,
                      {
                        onClick:
                          t[1] ||
                          (t[1] = () => {
                            n.value = n.value === A ? o(M)(n.value, '#ffffff', 0.5) : A;
                          }),
                      },
                      { default: c(() => [T(y(n.value === A ? '变浅' : '还原'), 1)]), _: 1 },
                    ),
                  ]),
                  _: 1,
                },
...
const Q = _(K, [['__scopeId', 'data-v-6c634103']]),
  V = Object.freeze(Object.defineProperty({ __proto__: null, default: Q }, Symbol.toStringTag, { value: 'Module' })),
  I = (a) => (R('data-v-16ed6503'), (a = a()), $(), a),
  W = I(() => l('div', { class: 'demo', style: { 'background-color': '#409eff' } }, '#409eff', -1)),
  Y = I(() => l('span', null, 'To', -1)),
  Z = h({
    __name: 'hexToRgb',
    setup(a) {
      const s = H('#409eff');
...
const s2 = _(Z, [['__scopeId', 'data-v-16ed6503']]),
  ...
  t2 = N(() => l('span', null, 'To', -1)),
  p2 = h({
    __name: 'hslToRgb',
    setup(a) {
      const s = L({ h: 210.47, s: 100, l: 62.54 });
      return (n, C) => {
        const t = g('el-row');
        return (
          r(),
...
const o2 = _(p2, [['__scopeId', 'data-v-2a3daccd']]),
  l2 = Object.freeze(Object.defineProperty({ __proto__: null, default: o2 }, Symbol.toStringTag, { value: 'Module' })),
  e2 = (a) => (R('data-v-c9b3ade9'), (a = a()), $(), a),
  C2 = e2(() => l('span', null, 'To', -1)),
  c2 = h({
    __name: 'rgbToHex',
    setup(a) {
      ...
      return (n, C) => {
        ...
        return (
          ...
          q(
            ...
            {
              default: c(() => [
                l('div', { class: 'demo', style: u({ backgroundColor: 'rgb(64,158,255)' }) }, y('rgb(64,158,255)'), 5),
                C2,
                l('div', { class: 'demo', style: u({ backgroundColor: o(s) }) }, y(o(s)), 5),
              ]),
              _: 1,
            },
          )
...
const E2 = _(c2, [['__scopeId', 'data-v-c9b3ade9']]),
  ...
  r2 = (a) => (R('data-v-ebd866e7'), (a = a()), $(), a),
  u2 = r2(() => l('span', null, 'To', -1)),
  F2 = h({
    __name: 'rgbToHsl',
    setup(a) {
      const s = z({ r: 64, g: 158, b: 255 });
      return (n, C) => {
        const t = g('el-row');
        return (
          r(),
...
const i2 = _(F2, [['__scopeId', 'data-v-ebd866e7']]),
  ...
  d2 = l(
    'h1',
    { id: 'color', tabindex: '-1' },
    [T('color '), l('a', { class: 'header-anchor', href: '#color', 'aria-label': 'Permalink to "color"' }, '​')],
    -1,
  ),
  A2 = l('p', null, '颜色装换工具', -1),
  g2 = l(
    'h2',
    { id: 'hextorgb', tabindex: '-1' },
    [
      T('hexToRgb '),
      l('a', { class: 'header-anchor', href: '#hextorgb', 'aria-label': 'Permalink to "hexToRgb"' }, '​'),
    ],
    -1,
  ),
  y2 = l('p', null, 'color/hexToRgb', -1),
  m2 = f(
...
<span class="line"><span style="color:#676E95;font-style:italic;">// return [&quot;#3c90e8&quot;,&quot;#3782d0&quot;,&quot;#3375b9&quot;,&quot;#2e67a1&quot;,&quot;#2a598a&quot;,&quot;#264b72&quot;,&quot;#213d5a&quot;,&quot;#1d3043&quot;,&quot;#18222b&quot;]</span></span></code></pre></div></details><p>参数:</p><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>color</td><td>主色</td><td>string</td><td></td></tr><tr><td>themeMode</td><td>颜色加深或者变浅</td><td>light / dark</td><td></td></tr></tbody></table><p>返回一个十六进制颜色字符串数组，类型<code>string[]</code>：</p>`,
    4,
  ),
  j2 = JSON.parse(
    '{"title":"color","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"guide/function/color.md","filePath":"guide/function/color.md","lastUpdated":1680448147000}',
  ),
  ...
  H2 = Object.assign(R2, {
    setup(a) {
      const s = Object.assign({
          ...
          '../../example/color/colorPalette.vue': V,
          '../../example/color/hexToRgb.vue': a2,
          '../../example/color/hslToRgb.vue': l2,
...
export { j2 as __pageData, H2 as default };
