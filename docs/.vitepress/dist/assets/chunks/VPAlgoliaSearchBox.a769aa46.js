import { d as Pr, l as Ir, m as kr, q as Dr, s as Cr, x as Ar, o as xr, g as Nr } from '../app.5368908a.js';
    ...
    (function (n, r) {
      ...
      if (o != null) {
        var a,
          ...
          s = !1;
        try {
          for (o = o.call(n); !(l = (a = o.next()).done) && (u.push(a.value), !r || u.length !== r); l = !0);
        } catch (i) {
          (s = !0), (c = i);
        } finally {
          try {
      ...
      e.some(function (t) {
        ...
        t.__d &&
          ...
          (u = n.__P) &&
            ((r = []),
            ((o = z({}, a)).__v = a.__v + 1),
            Et(u, a, o, n.__n, u.ownerSVGElement !== void 0, a.__h != null ? [c] : null, r, c ?? je(a), a.__h),
            zn(r, a),
            a.__e != c && Bn(a)));
      });
}
function Vn(e, t, n, r, o, a, c, u, l, s) {
  ...
  for (n.__k = [], i = 0; i < t.length; i++)
    if (
      ...
      if (((p.__ = n), (p.__b = n.__b + 1), (d = y[i]) === null || (d && p.key == d.key && p.type === d.type)))
        y[i] = void 0;
      else
        for (m = 0; m < S; m++) {
      ...
      Et(e, p, (d = d || Ke), o, a, c, u, l, s),
        (v = p.__e),
        (m = p.ref) && d.ref != m && (g || (g = []), d.ref && g.push(d.ref, null, p), g.push(m, p.__c || v, p)),
        v != null
          ? (h == null && (h = v),
  ...
  for (n.__e = h, i = S; i--; )
    y[i] != null &&
      (typeof n.type == 'function' && y[i].__e != null && y[i].__e == n.__d && (n.__d = je(r, i + 1)), $n(y[i], y[i]));
  if (g) for (i = 0; i < g.length; i++) Jn(g[i], g[++i], g[++i]);
}
function Wn(e, t, n) {
  var r, o;
  for (r = 0; r < e.__k.length; r++)
    (o = e.__k[r]) && ((o.__ = e), (t = typeof o.type == 'function' ? Wn(o, t, n) : Kn(n, o, o, e.__k, o.__e, t)));
  return t;
}
function J(e, t) {
  return (
...
function xt(e, t, n) {
  t[0] === '-' ? e.setProperty(t, n) : (e[t] = n == null ? '' : typeof n != 'number' || Lr.test(t) ? n : n + 'px');
}
function Ae(e, t, n, r, o) {
  ...
  e: if (t === 'style')
    if (typeof n == 'string') e.style.cssText = n;
      ...
      if ((typeof r == 'string' && (e.style.cssText = r = ''), r)) for (t in r) (n && t in n) || xt(e.style, t, '');
    ...
    typeof n == 'function' ||
      (n != null && (n !== !1 || (t[0] === 'a' && t[1] === 'r')) ? e.setAttribute(t, n) : e.removeAttribute(t));
  }
}
function Nt(e) {
...
function Et(e, t, n, r, o, a, c, u, l) {
  ...
  n.__h != null && ((l = n.__h), (u = t.__e = n.__e), (t.__h = null), (a = [u])), (s = w.__b) && s(t);
  try {
    e: if (typeof _ == 'function') {
      if (
        ...
        _.getDerivedStateFromProps != null &&
          (i.__s == i.state && (i.__s = z({}, i.__s)), z(i.__s, _.getDerivedStateFromProps(g, i.__s))),
        (d = i.props),
        (p = i.state),
        m)
      )
        _.getDerivedStateFromProps == null && i.componentWillMount != null && i.componentWillMount(),
        ...
        if (
          ...
          (!i.__e && i.shouldComponentUpdate != null && i.shouldComponentUpdate(g, i.__s, S) === !1) || t.__v === n.__v)
        ) {
          (i.props = g),
            (i.state = i.__s),
            t.__v !== n.__v && (i.__d = !1),
      ...
      (i.context = S),
        ...
        h && (i.__E = i.__ = null),
        (i.__e = !1);
    } else a == null && t.__v === n.__v ? ((t.__k = n.__k), (t.__e = n.__e)) : (t.__e = qr(n.__e, t, n, r, o, a, c, l));
    (s = w.diffed) && s(t);
  } catch (b) {
    (t.__v = null), (l || a != null) && ((t.__e = u), (t.__h = !!l), (a[a.indexOf(u)] = null)), w.__e(b, t, n);
  }
}
function zn(e, t) {
  w.__c && w.__c(t, e),
...
function qr(e, t, n, r, o, a, c, u) {
  ...
  if (e == null) {
    ...
    (e = o ? document.createElementNS('http://www.w3.org/2000/svg', v) : document.createElement(v, p.is && p)),
      (a = null),
      (u = !1);
  }
  if (v === null) d === p || (u && e.data === p) || (e.data = p);
    ...
    if (
      ...
      if (a != null) for (d = {}, m = 0; m < e.attributes.length; m++) d[e.attributes[m].name] = e.attributes[m].value;
      (i || s) &&
        ((i && ((s && i.__html == s.__html) || i.__html === e.innerHTML)) || (e.innerHTML = (i && i.__html) || ''));
    }
    if (
      ((function (g, y, S, O, _) {
        var b;
    ...
    u ||
      ...
      'checked' in p && (h = p.checked) !== void 0 && h !== e.checked && Ae(e, 'checked', h, d.checked, !1));
  }
  return e;
}
function Jn(e, t, n) {
...
(w.__e = function (e, t, n) {
  if (e.then) {
    for (var r, o = t; (o = o.__); )
      if ((r = o.__c) && r.__c) return t.__e == null && ((t.__e = n.__e), (t.__k = n.__k)), r.__c(e, t);
  }
  Vr(e, t, n);
}),
...
var rr = (typeof Symbol < 'u' && Symbol.for && Symbol.for('react.element')) || 60103,
  ...
  Jr = function (e) {
    return (typeof Symbol < 'u' && Ee(Symbol()) == 'symbol' ? /fil|che|rad/i : /fil|che|ra/i).test(e);
  };
function or(e, t, n) {
  return t.__k == null && (t.textContent = ''), Pe(e, t), typeof n == 'function' && n(), e ? e.__c : null;
}
...
w.event = function (e) {
  return (
    zt && (e = zt(e)), (e.persist = $r), (e.isPropagationStopped = Qr), (e.isDefaultPrevented = Zr), (e.nativeEvent = e)
  );
};
var ar,
  Jt = {
...
var f = {
  ...
  memo: function (e, t) {
    function n(o) {
      var a = this.props.ref,
        c = a == o.ref;
      return !c && a && (a.call ? a(null) : (a.current = null)), t ? !t(this.props, o) || !c : ht(this.props, o);
    }
    function r(o) {
  ...
  forwardRef: function (e) {
    function t(n, r) {
      var o = er({}, n);
      return delete o.ref, e(o, (r = n.ref || r) && (Ee(r) != 'object' || 'current' in r) ? r : null);
    }
    return (
      (t.$$typeof = Fr),
      (t.render = t),
    ...
    (function (n, r) {
      if (n) {
        ...
        if ((o === 'Object' && n.constructor && (o = n.constructor.name), o === 'Map' || o === 'Set'))
          return Array.from(n);
        if (o === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return Yt(n, r);
      }
    })(e, t) ||
    (function () {
      throw new TypeError(`Invalid attempt to destructure non-iterable instance.
...
var no = f.forwardRef(function (e, t) {
  ...
  return (
    ...
    f.createElement(
      'button',
      yt({ type: 'button', className: 'DocSearch DocSearch-Button', 'aria-label': l }, o, { ref: t }),
      f.createElement(
        'span',
      ...
      f.createElement(
        ...
        i !== null &&
          f.createElement(
            f.Fragment,
            null,
            f.createElement('kbd', { className: 'DocSearch-Button-Key' }, i === 'Ctrl' ? f.createElement(Gr, null) : i),
    ...
    (function (t, n) {
      if (t) {
        ...
        if ((r === 'Object' && t.constructor && (r = t.constructor.name), r === 'Map' || r === 'Set'))
          return Array.from(t);
        if (r === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return ot(t, n);
      }
    })(e) ||
    (function () {
      throw new TypeError(`Invalid attempt to spread non-iterable instance.
  ...
  return (
    ...
    (function (t, n) {
      if (t) {
        ...
        if ((r === 'Object' && t.constructor && (r = t.constructor.name), r === 'Map' || r === 'Set'))
          return Array.from(t);
        if (r === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return at(t, n);
      }
    })(e) ||
    (function () {
      throw new TypeError(`Invalid attempt to spread non-iterable instance.
                      ...
                      (i = s.hits) === null || i === void 0
                        ...
                        : i.map(function (m) {
                            return Ne(
                              Ne({}, m),
                              {},
                              { __autocomplete_indexName: s.index, __autocomplete_queryID: s.queryID },
                            );
                          }),
                  },
                );
...
function ae(e) {
  ...
  if ((m(a), d(o.defaultActiveItemId), !a && o.openOnFocus === !1)) {
    ...
    p('idle'), s(h), i((v = r.isOpen) !== null && v !== void 0 ? v : o.shouldPanelOpen({ state: u.getState() }));
    var g = Gt(
      fn(h).then(function () {
  ...
  var y = Gt(
    fn(
      o.getSources(ve({ query: a, refresh: c, state: u.getState() }, l)).then(function (S) {
        return Promise.all(
          S.map(function (O) {
            return Promise.resolve(O.getItems(ve({ query: a, refresh: c, state: u.getState() }, l))).then(function (_) {
    ...
    .then(function (S) {
      ...
      if (u.getState().activeItemId !== null && b) {
        var I = b.item,
          ...
          k = b.source;
        k.onActive(
          ve({ event: t, item: I, itemInputValue: N, itemUrl: A, refresh: c, source: k, state: u.getState() }, l),
        );
      }
    })
    .finally(function () {
...
function xo(e) {
  ...
  return {
      ...
      return x(
        {
          ...
          onTouchMove: function (i) {
            r.getState().isOpen !== !1 && c === t.environment.document.activeElement && i.target !== c && c.blur();
          },
        },
        _e(a, Io),
      );
    ...
    getInputProps: function (a) {
      ...
      function u(h) {
        (t.openOnFocus || Boolean(r.getState().query)) &&
          ae(x({ event: h, props: t, query: r.getState().completion || r.getState().query, refresh: n, store: r }, o)),
      ...
      return x(
        {
          ...
          type: 'search',
          onChange: function (h) {
            ae(x({ event: h, props: t, query: h.currentTarget.value.slice(0, i), refresh: n, store: r }, o));
          },
              ...
              if (y.key === 'ArrowUp' || y.key === 'ArrowDown') {
                ...
                y.preventDefault(),
                  _.getState().isOpen === !1 && (S.openOnFocus || Boolean(_.getState().query))
                    ? ae(X({ event: y, props: S, query: _.getState().query, refresh: O, store: _ }, b)).then(
                        function () {
                          _.dispatch(y.key, { nextActiveItemId: S.defaultActiveItemId }), N(), setTimeout(I, 0);
                        },
                      )
                    : (_.dispatch(y.key, {}), N(), I());
              } else if (y.key === 'Escape') y.preventDefault(), _.dispatch(y.key, null), _.pendingRequests.cancelAll();
                ...
                if (y.metaKey || y.ctrlKey)
                  ...
                  ae(X({ event: y, nextState: { isOpen: !1 }, props: S, query: R, refresh: O, store: _ }, b)).then(
                    function () {
                      B.onSelect(
                        X(
                          {
    ...
    getListProps: function (a) {
      return x({ role: 'listbox', 'aria-labelledby': ''.concat(t.id, '-label'), id: ''.concat(t.id, '-list') }, a);
    },
      ...
      return x(
        {
          ...
          onMouseMove: function (s) {
            if (c.__autocomplete_id !== r.getState().activeItemId) {
              ...
              if (r.getState().activeItemId !== null && i) {
                ...
                v.onActive(
                  x(
                    { event: s, item: m, itemInputValue: d, itemUrl: p, refresh: n, source: v, state: r.getState() },
                    o,
                  ),
                );
              }
          ...
          onClick: function (s) {
            ...
            (m
              ? Promise.resolve()
              : ae(x({ event: s, nextState: { isOpen: !1 }, props: t, query: i, refresh: n, store: r }, o))
            ).then(function () {
              u.onSelect(
                x({ event: s, item: c, itemInputValue: i, itemUrl: m, refresh: n, source: u, state: r.getState() }, o),
              );
            });
          },
        },
...
function Ro(e) {
  var t,
    ...
    c = e.options,
    u =
      (t = (((n = c.__autocomplete_metadata) === null || n === void 0 ? void 0 : n.userAgents) || [])[0]) === null ||
      t === void 0
        ? void 0
        : t.segment,
    l = u
      ? lr({}, u, Object.keys(((r = c.__autocomplete_metadata) === null || r === void 0 ? void 0 : r.options) || {}))
      : {};
  return {
    ...
    ua: oo.concat(((o = c.__autocomplete_metadata) === null || o === void 0 ? void 0 : o.userAgents) || []),
  };
}
function hn(e) {
  var t,
...
var Lo = function (e, t) {
  switch (t.type) {
    ...
    case 'ArrowUp':
      var r = E(E({}, e), {}, { activeItemId: Xt(-1, e.activeItemId, _t(e), t.props.defaultActiveItemId) });
    ...
    case 'reset':
      return E(
        E({}, e),
        {},
        { activeItemId: t.props.openOnFocus === !0 ? t.props.defaultActiveItemId : null, status: 'idle', query: '' },
      );
    case 'focus':
      return E(
        E({}, e),
                      ...
                      onSelect: function (h) {
                        v.onSelect(h),
                          l.forEach(function (g) {
                            var y;
                            return (y = g.onSelect) === null || y === void 0 ? void 0 : y.call(g, h);
                          });
                      },
                      onActive: function (h) {
                        v.onActive(h),
                          l.forEach(function (g) {
                            var y;
                            return (y = g.onActive) === null || y === void 0 ? void 0 : y.call(g, h);
                          });
                      },
                    },
                  );
  ...
  return (
    ...
    (function (u) {
      var l,
        ...
        m = u.environment;
      if (
        !((l = m.navigator) === null || l === void 0 || (s = l.userAgent) === null || s === void 0) &&
...
function Uo(e) {
  ...
  return f.createElement(
    f.Fragment,
    null,
    f.createElement('div', { className: 'DocSearch-Logo' }, f.createElement(Ho, { translations: { searchByText: S } })),
    f.createElement(
      'ul',
      ...
      f.createElement(
        ...
        f.createElement(
          'kbd',
          { className: 'DocSearch-Commands-Key' },
          f.createElement(Me, { ariaLabel: d }, f.createElement('path', { d: 'M7.5 3.5v8M10.5 8.5l-3 3-3-3' })),
        ),
        f.createElement(
          'kbd',
          { className: 'DocSearch-Commands-Key' },
          f.createElement(Me, { ariaLabel: i }, f.createElement('path', { d: 'M7.5 11.5v-8M10.5 6.5l-3-3-3 3' })),
        ),
  ...
  return (
    ...
    (function (t, n) {
      if (t) {
        ...
        if ((r === 'Object' && t.constructor && (r = t.constructor.name), r === 'Map' || r === 'Set'))
          return Array.from(t);
        if (r === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)) return it(t, n);
      }
    })(e) ||
    (function () {
      throw new TypeError(`Invalid attempt to spread non-iterable instance.
...
function oe(e) {
  ...
  return V(
    ...
    bn(
      bn({}, oa(e, na)),
      {},
      { dangerouslySetInnerHTML: { __html: On(t, '_snippetResult.'.concat(n, '.value')) || On(t, n) } },
    ),
  );
}
function Sn(e, t) {
  return (
    ...
    (function (n, r) {
      if (n) {
        ...
        if ((o === 'Object' && n.constructor && (o = n.constructor.name), o === 'Map' || o === 'Set'))
          return Array.from(n);
        if (o === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return wn(n, r);
      }
    })(e, t) ||
    (function () {
      throw new TypeError(`Invalid attempt to destructure non-iterable instance.
    ...
    ? f.createElement(
        ...
        f.createElement(
          ...
          e.collection.items.map(function (t, n) {
            return f.createElement(aa, Je({ key: [e.title, t.objectID].join(':'), item: t, index: n }, e));
          }),
        ),
      )
    : null;
  ...
  var u = (
    (c.__docsearch_parent
      ? (t = c.__docsearch_parent) === null ||
        ...
        ? void 0
        : r.lvl0
      : (o = e._highlightResult) === null || o === void 0 || (a = o.hierarchy) === null || a === void 0
      ? void 0
      : a.lvl0) || {}
  ).value;
              ...
              a.__docsearch_parent &&
                f.createElement(
                  ...
                  f.createElement(
                    ...
                    a.__docsearch_parent !==
                      ((o = t.items[c + 1]) === null || o === void 0 ? void 0 : o.__docsearch_parent)
                      ? f.createElement('path', { d: 'M8 6v21M20 27H8.3' })
                      : f.createElement('path', { d: 'M8 6v42M20 27H8.3' }),
                  ),
                ),
              f.createElement('div', { className: 'DocSearch-Hit-icon' }, f.createElement(zo, { type: a.type })),
            );
          },
          renderAction: function () {
            return f.createElement('div', { className: 'DocSearch-Hit-action' }, f.createElement(Wo, null));
          },
        }),
      );
    }),
    ...
    : f.createElement(
        ...
        f.createElement(
          ...
          $e({}, r, {
            ...
            renderIcon: function () {
              return f.createElement('div', { className: 'DocSearch-Hit-icon' }, f.createElement(Vo, null));
            },
        ...
        f.createElement(
          ...
          $e({}, r, {
            ...
            renderIcon: function () {
              return f.createElement('div', { className: 'DocSearch-Hit-icon' }, f.createElement(_n, null));
            },
            renderAction: function (g) {
              var y = g.item,
...
var da = f.memo(
    function (e) {
      var t = e.translations,
        n = t === void 0 ? {} : t,
        r = ma(e, pa);
      if (r.state.status === 'error') return f.createElement(Yo, { translations: n == null ? void 0 : n.errorScreen });
      ...
      return r.state.query
        ...
        : f.createElement(fa, Qe({}, r, { hasCollections: o, translations: n == null ? void 0 : n.startScreen }));
    },
    function (e, t) {
  ...
  return (
    ...
    f.createElement(
      ...
      f.createElement(
        ...
        f.createElement('div', { className: 'DocSearch-LoadingIndicator' }, f.createElement(Bo, null)),
        f.createElement(
          'input',
          Ze(
        ...
        f.createElement(
          'button',
          { type: 'reset', title: a, className: 'DocSearch-Reset', 'aria-label': u, hidden: !r.state.query },
          f.createElement(gt, null),
        ),
      ),
      f.createElement(
...
function _r(e) {
  ...
  return P(P({}, e), {}, { request: P(P({}, e.request), {}, { headers: P(P({}, e.request.headers), t) }) });
}
var ka = function (e) {
    var t = e.appId,
      n = (function (a, c, u) {
      ...
      r = (function (a) {
        ...
        P(
          ...
          {},
          {
            headers: P(P(P({}, n.headers()), { 'content-type': 'application/x-www-form-urlencoded' }), e.headers),
  ...
  An = function (e) {
    return function (t, n) {
      ...
      return e.transporter.read({ method: Ge, path: '1/indexes/*/queries', data: { requests: r }, cacheable: !0 }, n);
    };
  },
  xn = function (e) {
    return function (t, n) {
  ...
  Ca = function (e) {
    return function (t, n) {
      return e.transporter.read(
        { method: Ge, path: Ye('1/indexes/%s/query', e.indexName), data: { query: t }, cacheable: !0 },
        n,
      );
    };
  },
            ...
            (u.onreadystatechange = function () {
              ...
              (u.onerror = function () {
                u.status === 0 &&
                  (clearTimeout(i),
                  clearTimeout(l),
                  c({ content: u.responseText || 'Network request failed', status: u.status, isTimedOut: !1 }));
              }),
              (u.onload = function () {
                clearTimeout(i), clearTimeout(l), c({ content: u.responseText, status: u.status, isTimedOut: !1 });
              }),
              u.send(a.data);
          });
        },
      ...
      {},
      {
        methods: {
          ...
          initIndex: function (a) {
            return function (c) {
              return gr(a)(c, { methods: { search: Ca, searchForFacetValues: br, findAnswers: Da } });
            };
          },
        },
      },
  ...
  return (
    ...
    (function (n, r) {
      if (n) {
        ...
        if ((o === 'Object' && n.constructor && (o = n.constructor.name), o === 'Map' || o === 'Set'))
          return Array.from(n);
        if (o === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return Rn(n, r);
      }
    })(e, t) ||
    (function () {
      throw new TypeError(`Invalid attempt to destructure non-iterable instance.
...
function Ma(e) {
  var t = e.appId,
    ...
    pe = f.useRef(
      Pn({ key: '__DOCSEARCH_RECENT_SEARCHES__'.concat(r), limit: te.getAll().length === 0 ? 7 : 4 }),
    ).current,
    me = f.useCallback(
      function (j) {
        if (!b) {
                                  ...
                                  return lt(
                                    ...
                                    {},
                                    {
                                      __docsearch_parent:
                                        he.type !== 'lvl1' &&
                                        K.find(function (ne) {
                                          return ne.type === 'lvl1' && ne.hierarchy.lvl1 === he.hierarchy.lvl1;
                                        }),
                                    },
                                  );
                                });
  ...
  return (
        ...
        function () {
          if (M && H && Q) {
            ...
            return (
              ...
              function () {
                window.removeEventListener('touchstart', U), window.removeEventListener('touchmove', F);
              }
            );
          }
        },
    ...
    })({ getEnvironmentProps: Sr, panelElement: Ce.current, formElement: Pt.current, inputElement: fe.current }),
    (function (j) {
      var D = j.container;
      f.useEffect(
        function () {
          if (D) {
            var M = D.querySelectorAll('a[href]:not([disabled]), button:not([disabled]), input:not([disabled])'),
              H = M[0],
              Q = M[M.length - 1];
            return (
    ...
    f.createElement(
      ...
      f.createElement(
        ...
        f.createElement('footer', { className: 'DocSearch-Footer' }, f.createElement(Uo, { translations: L })),
      ),
    )
  );
}
  ...
  return (
    ...
    (function (n, r) {
      if (n) {
        ...
        if ((o === 'Object' && n.constructor && (o = n.constructor.name), o === 'Map' || o === 'Set'))
          return Array.from(n);
        if (o === 'Arguments' || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)) return Ln(n, r);
      }
    })(e, t) ||
    (function () {
      throw new TypeError(`Invalid attempt to destructure non-iterable instance.
    ...
    f.createElement(
      ...
      st({}, e, {
        transformSearchClient: function (t) {
          return t.addAlgoliaAgent('docsearch.js', '3.3.2'), e.transformSearchClient ? e.transformSearchClient(t) : t;
        },
      }),
    ),
    (function (t) {
    ...
    setup(e) {
      ...
      function l() {
        ...
        const m = { ...t.algolia, ...((v = t.algolia.locales) == null ? void 0 : v[a.value]) },
          ...
          p = [...(Array.isArray(d) ? d : [d]).filter((g) => !g.startsWith('lang:')), `lang:${c.value}`];
      ...
      function i(m) {
        ...
        return d.replace(/\.html$/, o.value.cleanUrls ? '' : '.html') + p;
      }
