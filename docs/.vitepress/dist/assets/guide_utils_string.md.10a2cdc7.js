    ...
    setup(a) {
      ...
      return (d, C) => {
        ...
        return (
          F(),
          k('div', null, [
            p(i, { onClick: t }, { default: o(() => [e(E(s.value ? '还原' : '转换'), 1)]), _: 1 }),
            p(
              u,
              { style: { 'margin-left': '12px' }, type: 'danger' },
              { default: o(() => [e(E(s.value ? D(m)(n.value) : n.value), 1)]), _: 1 },
            ),
          ])
        );
      };
        ...
        return (
          ...
          k('div', null, [
            ...
            p(
              u,
              { style: { 'margin-left': '12px' }, type: 'danger' },
              { default: o(() => [e(E(s.value ? D(y)(n.value, 'upperCamelCase') : n.value), 1)]), _: 1 },
            ),
          ])
        );
      };
...
<span class="line"></span></code></pre></div></details><p>参数：</p><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>str</td><td>需要删除的字符串</td><td>string</td><td></td></tr><tr><td>substrings</td><td>需要删除的内容</td><td>string[]</td><td></td></tr></tbody></table><p>返回类型：<code>string</code></p>`,
    11,
  ),
  q = JSON.parse(
    '{"title":"string","description":"","frontmatter":{"outline":"deep"},"headers":[{"level":2,"title":"stringTrim","slug":"stringtrim","link":"#stringtrim","children":[]},{"level":2,"title":"transformString","slug":"transformstring","link":"#transformstring","children":[]},{"level":2,"title":"removeString","slug":"removestring","link":"#removestring","children":[]}],"relativePath":"guide/utils/string.md","lastUpdated":1689344950000}',
  ),
