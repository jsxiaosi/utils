...
function B(t, s) {
  return new Promise((a, o) => {
    const n = document.createElement('CANVAS'),
      p = n == null ? void 0 : n.getContext('2d'),
      l = new Image();
    (l.crossOrigin = 'Anonymous'),
      (l.onload = function () {
        if (!n || !p) return o();
        (n.height = l.height), (n.width = l.width), p.drawImage(l, 0, 0);
...
function k(t, s) {
  return new Promise((a, o) => {
    fetch(t, s).then((n) => {
      n.status === 200 ? a(n.blob()) : o();
    });
  });
}
function y(t, s, a) {
  const o = [t],
    n = new Blob(o, { type: a || 'application/octet-stream' }),
    p = window.URL.createObjectURL(n),
...
const x = { class: 'demos_content' },
  w = F({
    ...
    setup(t) {
      ...
      return (a, o) => {
        const n = E('ElButton');
        return i(), u('div', x, [e(n, { onClick: s }, { default: c(() => [r('保存文件到本地')]), _: 1 })]);
      };
    },
  }),
  T = Object.freeze(Object.defineProperty({ __proto__: null, default: w }, Symbol.toStringTag, { value: 'Module' })),
  j = F({
    __name: 'downloadUrlFile',
    setup(t) {
      const s = () => {
          b('https://supercutexiaosi.top/resource/develop_pdf.pdf', 'develop_pdf.pdf');
        },
        a = () => {
          b('https://supercutexiaosi.top/resource/develop_docx.docx', 'develop_docx.docx');
        };
      return (o, n) => {
        const p = E('ElButton');
        return (
          i(),
          u('div', null, [
            e(p, { onClick: s }, { default: c(() => [r('下载PDF')]), _: 1 }),
            e(p, { onClick: a }, { default: c(() => [r('下载Docx')]), _: 1 }),
          ])
        );
      };
    },
  }),
  S = Object.freeze(Object.defineProperty({ __proto__: null, default: j }, Symbol.toStringTag, { value: 'Module' })),
  U = F({
  ...
  I = Object.freeze(Object.defineProperty({ __proto__: null, default: U }, Symbol.toStringTag, { value: 'Module' })),
  P = { class: 'demos_content' },
  q = F({
    __name: 'urlToBase64',
    setup(t) {
      const s = h(),
        a = async () => {
          s.value = await B('https://supercutexiaosi.top/resource/account_url.png');
        };
      return (o, n) => {
        const p = E('ElButton'),
          l = E('ElImage');
        return (
          i(),
          u('div', P, [
            e(p, { onClick: a }, { default: c(() => [r('url图片转成base64')]), _: 1 }),
...
const R = g(q, [['__scopeId', 'data-v-e4925a57']]),
  N = Object.freeze(Object.defineProperty({ __proto__: null, default: R }, Symbol.toStringTag, { value: 'Module' })),
  O = { class: 'demos_content' },
  V = F({
    __name: 'urlToBlob',
    setup(t) {
      const s = h(),
        a = () => {
          k('https://supercutexiaosi.top/resource/account_url.png').then((o) => {
            f(o).then((n) => {
              s.value = n;
            });
          });
      ...
      return (o, n) => {
        ...
        return (
          i(),
          u('div', O, [
            e(p, { onClick: a }, { default: c(() => [r('url转Blob')]), _: 1 }),
            e(l, { class: 'image', src: s.value }, null, 8, ['src']),
          ])
        );
      };
...
const L = g(V, [['__scopeId', 'data-v-d2ac2dc6']]),
  $ = Object.freeze(Object.defineProperty({ __proto__: null, default: L }, Symbol.toStringTag, { value: 'Module' })),
  M = C(
    'h1',
    { id: '文件流转换', tabindex: '-1' },
    [r('文件流转换 '), C('a', { class: 'header-anchor', href: '#文件流转换', 'aria-hidden': 'true' }, '#')],
    -1,
  ),
  z = C(
    'h2',
    { id: '下载图片', tabindex: '-1' },
    [r('下载图片 '), C('a', { class: 'header-anchor', href: '#下载图片', 'aria-hidden': 'true' }, '#')],
    -1,
  ),
  W = C('p', null, 'file/downloadUrlImage', -1),
  J = d('', 4),
  ...
  p2 = Object.assign(a2, {
    setup(t) {
      const s = Object.assign({
          ...
          '../../example/file/downloadUrlFile.vue': S,
          '../../example/file/downloadUrlImage.vue': I,
          '../../example/file/urlToBase64.vue': N,
...
export { t2 as __pageData, p2 as default };
