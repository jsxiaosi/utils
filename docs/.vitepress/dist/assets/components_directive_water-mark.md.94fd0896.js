...
const F = a(
  ...
  h = i(
    '<h2 id="参数" tabindex="-1">参数 <a class="header-anchor" href="#参数" aria-hidden="true">#</a></h2><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>text</td><td>水印文字</td><td>string</td><td></td></tr></tbody></table>',
    2,
  ),
  f = JSON.parse(
