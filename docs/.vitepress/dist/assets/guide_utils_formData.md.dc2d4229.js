    ...
    if (Object.prototype.hasOwnProperty.call(c, o)) {
      ...
      if (Array.isArray(a))
        for (let r = 0; r < a.length; r++) {
          const k = `${e}[${r}]`,
            u = a[r];
          typeof u == 'object' ? F(u, t, k) : t.append(k, u);
        }
      else typeof a == 'object' ? F(a, t, e) : t.append(e, a);
    }
  return t;
}
const b = s(
  ...
  v = Object.freeze(Object.defineProperty({ __proto__: null, default: _ }, Symbol.toStringTag, { value: 'Module' })),
  T = s(
    'div',
    null,
    [
  ...
  S = s(
    ...
    [n('FormData '), s('a', { class: 'header-anchor', href: '#formdata', 'aria-hidden': 'true' }, '#')],
    -1,
  ),
  q = s(
    'h2',
    { id: 'objecttoformdata', tabindex: '-1' },
    [n('objectToFormData '), s('a', { class: 'header-anchor', href: '#objecttoformdata', 'aria-hidden': 'true' }, '#')],
    -1,
  ),
...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#82AAFF;">objectToFormData</span><span style="color:#A6ACCD;">(obj</span><span style="color:#89DDFF;">,</span><span style="color:#A6ACCD;"> formData)</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span></code></pre></div></details><p>参数:</p><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>obj</td><td>转换的对象</td><td>T</td><td></td></tr><tr><td>outFormData</td><td>需要添加数据的FormData，不传默认生成一个FormData返回</td><td>FormData</td><td>FormData</td></tr></tbody></table><p>返回类型：<code>FormData</code></p><h2 id="mergeformdata" tabindex="-1">mergeFormData <a class="header-anchor" href="#mergeformdata" aria-hidden="true">#</a></h2><p>合并两个FormData，将来源FormData合并到目标FormData</p><details class="details custom-block"><summary>示例代码</summary><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;font-style:italic;">import</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span><span style="color:#F07178;"> </span><span style="color:#A6ACCD;">objectToFormData</span><span style="color:#F07178;"> </span><span style="color:#89DDFF;">}</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;font-style:italic;">from</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">@jsxiaosi/utils</span><span style="color:#89DDFF;">&#39;</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#C792EA;">const</span><span style="color:#A6ACCD;"> formData </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">new</span><span style="color:#A6ACCD;"> </span><span style="color:#82AAFF;">FormData</span><span style="color:#A6ACCD;">()</span><span style="color:#89DDFF;">;</span></span>
<span class="line"><span style="color:#A6ACCD;">  formData</span><span style="color:#89DDFF;">.</span><span style="color:#82AAFF;">append</span><span style="color:#A6ACCD;">(</span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">name</span><span style="color:#89DDFF;">&#39;</span><span style="color:#89DDFF;">,</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">Alice</span><span style="color:#89DDFF;">&#39;</span><span style="color:#A6ACCD;">)</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#82AAFF;">mergeFormData</span><span style="color:#A6ACCD;">(formData</span><span style="color:#89DDFF;">,</span><span style="color:#A6ACCD;">formData2)</span></span>
<span class="line"></span></code></pre></div></details><p>参数:</p><table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>targetFormData</td><td>目标FormData</td><td>FormData</td><td></td></tr><tr><td>sourceFormData</td><td>来源FormData</td><td>FormData</td><td></td></tr></tbody></table><p>返回类型：<code>FormData</code></p>`,
    10,
  ),
  z = JSON.parse(
    '{"title":"FormData","description":"","frontmatter":{"outline":"deep"},"headers":[{"level":2,"title":"objectToFormData","slug":"objecttoformdata","link":"#objecttoformdata","children":[]},{"level":2,"title":"mergeFormData","slug":"mergeformdata","link":"#mergeformdata","children":[]}],"relativePath":"guide/utils/formData.md","lastUpdated":1680448147000}',
  ),
  P = { name: 'guide/utils/formData.md' },
  M = Object.assign(P, {
    setup(c) {
      const p = Object.assign({
          '../../example/formData/objectToFormData.vue': v,
...
export { z as __pageData, M as default };
